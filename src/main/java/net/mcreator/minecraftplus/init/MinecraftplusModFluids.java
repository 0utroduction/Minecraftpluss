...
import net.mcreator.minecraftplus.fluid.MercuryFluid;
...
public class MinecraftplusModFluids {
	...
	public static final RegistryObject<FlowingFluid> MERCURY = REGISTRY.register("mercury", () -> new MercuryFluid.Source());
	public static final RegistryObject<FlowingFluid> FLOWING_MERCURY = REGISTRY.register("flowing_mercury", () -> new MercuryFluid.Flowing());
